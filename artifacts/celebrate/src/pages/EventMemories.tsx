  ...
  return (
    ...
    >
      <div style={{
        ...
        <button
          onClick={onClose}
          style={{ position: 'absolute', top: 20, right: 20, background: 'none', border: 'none', cursor: 'pointer', color: '#c6b7a1' }}
        >
          <X size={18} />
        </button>

        <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 10, letterSpacing: '0.28em', textTransform: 'uppercase', color: '#c6b7a1', marginBottom: 24 }}>
          Add a memory
        </p>

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div>
            <label style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: '0.12em', color: '#c6b7a1', display: 'block', marginBottom: 8 }}>
              Photo URL
            </label>
            <input
              ref={urlRef}
          ...
          <button
            ...
            style={{
              ...
              color: saving ? '#c6b7a1' : '#c9a96e', background: 'none',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div style={{ padding: '48px 32px 32px' }}>
        <p style={{ fontSize: 10, letterSpacing: '0.28em', textTransform: 'uppercase', color: '#c6b7a1', marginBottom: 12 }}>
          Memory Album
        </p>
        <h1 style={{
      ...
      <div style={{ padding: '0 32px 80px' }}>
        {loading ? (
          ...
          <div style={{ maxWidth: 400, paddingTop: 40 }}>
            <p style={{ fontSize: 14, fontWeight: 300, color: '#c6b7a1', lineHeight: 1.7, marginBottom: 32 }}>
          ...
          <div style={{
            ...
            >
              ...
              <span style={{ fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c6b7a1' }}>
                Add memory
              </span>
            </button>
          </div>
